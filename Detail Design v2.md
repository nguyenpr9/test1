...
| Phiên bản tài liệu | v2.4 - Detail Design (DashboardCatalog + LayoutSpec aligned) |
...
| v2.4 | 2026-02-10 | Senior BI Solution Architect | Hoàn thiện đồng bộ DashboardCatalog và DashboardLayoutSpec cho DB-05/DB-06 (design ready for implementation). |
...
| Contractor Scorecard | Contractor Benchmark | CS01 | Card | 20 | 20 | 180 | 80 | [Contractor Productivity Index] | Last 3 months | Cross-highlight all visuals | KPI năng suất nhà thầu |
| Contractor Scorecard | Contractor Benchmark | CS02 | Card | 220 | 20 | 180 | 80 | [On-time Delivery %] | Last 3 months | Cross-highlight all visuals | KPI đúng hạn giao vật tư |
| Contractor Scorecard | Contractor Benchmark | CS03 | Card | 420 | 20 | 180 | 80 | [SLA Violation Count] | Last 3 months | Cross-highlight all visuals | KPI vi phạm SLA |
| Contractor Scorecard | Contractor Benchmark | CS04 | Bar | 20 | 120 | 640 | 260 | Axis:Contractor; Value:[Contractor Productivity Index] | TopN15 contractors | Select contractor filters matrix + trend | Xếp hạng nhà thầu theo năng suất |
| Contractor Scorecard | Contractor Benchmark | CS05 | Line | 680 | 120 | 640 | 260 | Axis:Month; Values:[On-time Delivery %],[SLA Violation Count] | Last 12 months | Select month filters ranking + detail | Xu hướng SLA theo thời gian |
| Contractor Scorecard | Contractor Benchmark | CS06 | Matrix | 20 | 400 | 940 | 280 | Rows:Contractor->Project; Values:Productivity,On-time%,SLA Violations | ContractorType slicer | Drill contractor -> project | Benchmark đa chỉ số |
| Contractor Scorecard | Contractor Benchmark | CS07 | Table | 980 | 400 | 340 | 280 | Contractor,Project,WorkPackage,IssueType,IssueDate,Owner | SLA Violation Count > 0 | Drillthrough to contractor detail | Danh sách vi phạm chi tiết |
| Acceptance & Billing Tracker | Acceptance to Payment | AB01 | Card | 20 | 20 | 180 | 80 | [Accepted Qty] | Current + previous month | Cross-highlight all visuals | KPI khối lượng nghiệm thu |
| Acceptance & Billing Tracker | Acceptance to Payment | AB02 | Card | 220 | 20 | 180 | 80 | [Pending Billing Amount] | Current + previous month | Cross-highlight all visuals | KPI tồn đọng thanh toán |
| Acceptance & Billing Tracker | Acceptance to Payment | AB03 | Card | 420 | 20 | 180 | 80 | [Payment Delay Days] | Current + previous month | Cross-highlight all visuals | KPI trễ thanh toán |
| Acceptance & Billing Tracker | Acceptance to Payment | AB04 | Funnel | 20 | 120 | 520 | 260 | Stage:BillingStatus; Value:DocumentCount | Status in Pending/Approved/Paid | Select stage filters pending list | Workflow hồ sơ thanh toán |
| Acceptance & Billing Tracker | Acceptance to Payment | AB05 | Column | 560 | 120 | 760 | 260 | Axis:Project; Value:[Pending Billing Amount] | TopN15 by pending amount | Select project filters tables | Công trình tồn đọng cao |
| Acceptance & Billing Tracker | Acceptance to Payment | AB06 | Table | 20 | 400 | 940 | 280 | DocNo,Project,Phase,AcceptedQty,BillingAmount,Status,DueDate | Status <> Paid | Drillthrough to certificate/document | Danh sách hồ sơ pending |
| Acceptance & Billing Tracker | Acceptance to Payment | AB07 | Table | 980 | 400 | 340 | 280 | DocNo,Project,DelayDays,Owner,ActionRequired | DelayDays > 0 | Conditional color + alert action | Danh sách quá hạn SLA |
...
| DB-05 | Contractor Scorecard / Contractor Benchmark | M04 | Đánh giá hiệu suất nhà thầu theo productivity, SLA và mức độ tuân thủ. | Contract Manager, PMO | Quyết định lựa chọn nhà thầu cho giai đoạn tiếp theo và kế hoạch cải thiện SLA. | DimContractor, FactProgressTracking, FactMaterialConsumption, DeliveryPerformance | 3 KPI tier cards + contractor ranking bar + SLA trend line + benchmark matrix + detail drill table. | [Contractor Productivity Index], [On-time Delivery %], [SLA Violation Count] | Default last 3 months; slicers: ContractorType, Region, Project. | Drill contractor -> project -> work package; tooltip hiển thị SLA detail. | DashboardLayoutSpec: CS01..CS07 (Contractor Benchmark) | ContractorViewer chỉ nhìn own company; internal roles có đầy đủ benchmark cross-contractor. | P95 query < 5 giây sau khi triển khai page chuyên biệt. | 1) Ranking stable theo weighted score<br>2) External role không nhìn cross-company benchmark | Contract BI Product Owner / Design Ready (Sprint+2) |
| DB-06 | Acceptance & Billing Tracker / Acceptance to Payment | M05 | Theo dõi vòng đời nghiệm thu -> thanh toán và phát hiện hồ sơ quá hạn SLA. | QS, Site Engineer, Finance Ops | Quyết định đẩy nhanh hồ sơ pending và giảm tồn đọng thanh toán. | AcceptanceMinutes, BillingProgress, PaymentCertificate, FactProgressTracking, DimDate | 3 KPI cards + billing workflow funnel + pending list table + delay alert table + document drillthrough. | [Accepted Qty], [Pending Billing Amount], [Payment Delay Days], [Billing SLA Breach %] | Default current month + previous month; slicers: Project, Phase, BillingStatus. | Click funnel status filters pending list; drill to certificate/document detail. | DashboardLayoutSpec: AB01..AB07 (Acceptance to Payment) | RLS theo project + role; ContractorViewer không truy cập billing amount chi tiết công ty nội bộ. | P95 query < 5 giây với data window 12 tháng. | 1) Pending amount đối soát AP<br>2) Delay alert đúng SLA rule<br>3) Drill tới chứng từ thanh toán chính xác | Finance Ops BI / Design Ready (Sprint+3) |
